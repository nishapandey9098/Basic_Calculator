...
for row in range(row_count):
    for column in range(column_count):
        ...
        if value in top_symbols:
            button.config(foreground=color_black, background=color_pink)
        elif value in right_symbols:
            button.config(foreground=color_white, background=color_green)
        elif value in bottom_symbols:
            button.config(foreground=color_black, background=color_purple)
        else:
